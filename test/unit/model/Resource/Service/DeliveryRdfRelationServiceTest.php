...
class DeliveryRdfRelationServiceTest extends TestCase
{
    ...
    private DeliveryRdfRelationService $subject;
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = new DeliveryRdfRelationService();
    ...
    public function testReturnsDeliveryRelationsMatchingOrigin(): void
    {
        ...
        $result = $this->subject->findRelations(new FindAllQuery(self::TEST_URI, null, 'delivery_rdf'));
