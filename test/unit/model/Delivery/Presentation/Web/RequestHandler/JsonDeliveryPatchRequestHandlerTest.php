...
class JsonDeliveryPatchRequestHandlerTest extends TestCase
{
    /** @var JsonDeliveryPatchRequestHandler */
    private $sut;
    ...
    {
        $this->sut = new JsonDeliveryPatchRequestHandler();
     ...
     *           [true, "application/x-json, application/json"]
     */
