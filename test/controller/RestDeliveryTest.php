...
class RestDeliveryTest extends RestTestRunner
{
    ...
    public function testCreateClass()
    {
        ...
        $deliveryParent = (new \core_kernel_classes_Class(DeliveryAssemblyService::CLASS_ID))->createSubClass();
    ...
    public function testCreateSubClass()
    {
        $label = 'fixture';
        $comment = 'commentFixture';
        $deliveryParent1 = (new \core_kernel_classes_Class(DeliveryAssemblyService::CLASS_ID))->createSubClass();
