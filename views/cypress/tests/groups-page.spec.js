...
describe('Deliveries Page', () => {
    ...
    describe('Deliveries page', () => {
        it('should be Deliveries menu button', function () {
            cy.get('nav ul.main-menu li.active a span.icon-delivery').should('have.length', 1);
        });

        it('should be left panel with Deliveries tree', function () {
            cy.get('div.taotree-delivery').find('ul').children().should('not.to.have.length', 0);
        });
