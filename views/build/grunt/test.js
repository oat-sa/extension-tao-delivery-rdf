module.exports = function(grunt) {
    ...
    var testRunners = root + '/taoDeliveryRdf/views/js/test/**/test.html';
    var testFiles = root + '/taoDeliveryRdf/views/js/test/**/test.js';
    ...
    watch.taodeliveryrdf = {
        files : [testRunners, testFiles],
        tasks : ['qunit:taodeliveryrdf'],
        options : {
            debounceDelay : 10000
        }
    };
    ...
    // bundle task
    grunt.registerTask('taodeliveryrdftest', ['qunit:taodeliveryrdf']);
};
