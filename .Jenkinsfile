        ...
        stage('Install') {
            agent {
                docker {
                    ...
                    reuseNode true
                    args '-e PINGIGIST_BRANCH_NAME=${CHANGE_BRANCH} -e PINGIGIST_REPO_NAME=${REPO_NAME}'
                }
            }
            environment {
                HOME = '.'
